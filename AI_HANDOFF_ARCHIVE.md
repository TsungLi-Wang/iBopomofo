...
## 棒⑭-K ～ ㉕ 的逐棒敘事（2026-08-17～19；2026-08-19 從交班檔搬過來）

> 搬過來的原因：交班檔規定「目標一頁」，這幾段累積到 172 行。
> **結論已經各自歸位**（機制線收斂在 `docs/dead-ends.md`、方向判定在
> `docs/decisions/0009`、健檢在 `0010`、方法調查在 `docs/research/`、
> 每棒改了什麼在 `CHANGELOG.md`），這裡只留敘事。
