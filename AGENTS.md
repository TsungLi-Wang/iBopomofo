...
**Current line:** **i注音 / iBopomofo v2.12.0** (build 2306; tag `v2.12.0`). Path β: hard commit on sentence end (no soft-finalize mid-state); reselect only via delete-and-recompose shadow table. Shipping scores λ/ν 0.75 → tw538 **387/537**. Handoff: `AI_HANDOFF_PROMPT.md` + `CHANGELOG.md`.
