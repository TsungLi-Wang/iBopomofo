...
**Current line:** **i注音 / iBopomofo v2.12.1** (build 2307; tag `v2.12.1`). Path β: pause = auto-rerank (underline stays); Enter = hard-commit + send; post-commit reselect = delete-and-recompose only. Shipping scores λ/ν 0.75 → tw538 **387/537**. Handoff: `AI_HANDOFF_PROMPT.md` + `CHANGELOG.md`.
