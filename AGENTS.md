...
**Current line:** **i注音 / iBopomofo v2.13.0** (build 2308; tag `v2.13.0`). Canonical UX: 定案 (改字+收底線) ≠ 送出; pause/。/，/Enter-while-underlined finalize without send; second Enter sends; post-commit ↓ = delete-and-recompose. Shipping scores λ/ν 0.75 → tw538 **387/537**. Handoff: `AI_HANDOFF_PROMPT.md` + `CHANGELOG.md`.
