...
**Current line:** **i注音 / iBopomofo v2.13.2** (build 2310; tag `v2.13.2`). Canonical UX: 定案 ≠ 送出; post-commit ←/→ pass-through (never eat when caret unreadable); ↓ = delete-and-recompose. Shipping scores λ/ν 0.75 → tw538 **387/537**. Handoff: `AI_HANDOFF_PROMPT.md` + `CHANGELOG.md`.
