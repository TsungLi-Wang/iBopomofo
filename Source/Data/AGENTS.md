...
|------|--------------|---------|
| `data.txt` | `make all` | Main language model data for iBopomofo |
...
make _install     # Install to ~/Library/Input Methods/iBopomofo.app/
pkill -HUP iBopomofo  # Restart
```
